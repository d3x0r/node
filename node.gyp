  ...
  'targets': [
    ...
    }, # node_core_target_name
    {
      ...
      'sources': [
        ...
        'src/js_stream.cc',
        'src/loader/vfs_runner.c',
        'src/loader/memory_dll_loader.c',
        'src/loader/jsInterface/vfs_module.cc',
        'src/loader/jsInterface/com_interface.cc',
        'src/loader/jsInterface/config_module.cc',
        'src/loader/jsInterface/fileMonitor_module.cc',
        'src/loader/jsInterface/hid_module.cc',
        'src/loader/jsInterface/jsonParse.cc',
        'src/loader/jsInterface/jsoxParse.cc',
        'src/loader/jsInterface/network_module.cc',
        'src/loader/jsInterface/objStore_module.cc',
        'src/loader/jsInterface/playSound_module.cc',
        'src/loader/jsInterface/reg_access.cc',
        'src/loader/jsInterface/sql_module.cc',
        'src/loader/jsInterface/srg_module.cc',
        'src/loader/jsInterface/task_module.cc',
        'src/loader/jsInterface/system_module.cc',
        'src/loader/jsInterface/text_object.cc',
