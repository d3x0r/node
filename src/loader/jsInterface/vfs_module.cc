...
void VolumeObject::doInit( Local<Object> exports, Local<Context> context )
{
	InvokeDeadstart();
...
void VolumeObject::Init (Local< Object > exports, Local< Value > module, Local< Context > context, void *priv) {
	doInit( exports, context );	
}

//void VolumeObject::Init( Local<Object> exports )  {
//	doInit( exports, Local<Context>() );
//}
...
NODE_MODULE_CONTEXT_AWARE_INTERNAL( sack, VolumeObject::Init)
